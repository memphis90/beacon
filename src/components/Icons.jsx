...
/* Il logo di GitHub, unico segno in questo file che non sia un tratto: il
   marchio è riconoscibile solo nella sua forma, e un'icona generica di "codice"
   non direbbe dove porta il collegamento. */
export const IconGitHub = ({ filled, ...p }) => (
